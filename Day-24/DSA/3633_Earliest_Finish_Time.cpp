...
// Approach:
//   - Simulate both orderings: Land→Water and Water→Land.
//   - Try all pairs of start times, taking care of delays if the next ride isn't available yet.
//   - Track and return the minimum finish time among all valid combinations.
// Time Complexity: O(n^2), where n is the number of rides.
